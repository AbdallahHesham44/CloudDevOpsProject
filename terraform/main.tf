...
module "ec2_instance" {
  ...
  subnet_id         = module.subnet.public_subnet_ids[0]  # Pass the first public subnet ID
  security_group_id = module.security_group.security_group_id  # Pass the security group ID
